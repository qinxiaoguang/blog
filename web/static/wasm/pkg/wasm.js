...
class RandGame {
    ...
    static __wrap(ptr) {
        const obj = Object.create(RandGame.prototype);
        obj.ptr = ptr;
    ...
    free() {
        ...
        wasm.__wbg_randgame_free(ptr);
    }
    /**
    * @returns {number}
    */
    width() {
        var ret = wasm.randgame_width(this.ptr);
        return ret >>> 0;
    }
    /**
    * @returns {number}
    */
    height() {
        var ret = wasm.randgame_height(this.ptr);
        return ret >>> 0;
    }
    /**
    * @returns {number}
    */
    count() {
        var ret = wasm.randgame_count(this.ptr);
        return ret;
    }
    /**
    */
    tick() {
        wasm.randgame_tick(this.ptr);
    }
    /**
    * @param {number} cnt
    * @returns {RandGame}
    */
    static new(cnt) {
        var ret = wasm.randgame_new(cnt);
        return RandGame.__wrap(ret);
    }
    /**
    * @returns {string}
    */
    render() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.randgame_render(retptr, this.ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            return getStringFromWasm0(r0, r1);
        } finally {
...
class RgCell {
    ...
    */
    tick(width, height) {
        wasm.rgcell_tick(this.ptr, width, height);
    }
}
__exports.RgCell = RgCell;
/**
*/
class Universe {
